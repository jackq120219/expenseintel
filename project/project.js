(()=>{
  ...
  function bottlenecks(input,utility){
    ...
    const scheduleBase=input.months<=5?92:input.months<=8?72:input.months<=12?52:30;
    const scores={
      ...
      schedule:clamp(scheduleBase+(t.has('specialEquipment')?18:0)+(t.has('utilityUpgrade')?16:0)),
  ...
  function failurePatterns(input,utility,undo){
