...
module.exports=async function handler(req,res){
  ...
  try{
    const out=await gather({text,url,category:categoryHint(category,url,text),price,location});
